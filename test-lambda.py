...
database_name = "hogtrap-01-email"
table_name = "email_info"
# NEED TO CHANGE - S3 bucket to output query result of Athena
s3_result_path = "s3://cbchogtrap-01-athena"

# NEED TO CHANGE - Data Path 
s3_data_path = "s3://cbc-hogtraps-01-email-log-file-json/"
s3_folder = "cbc-hogtraps-01-email-log-file-json"
